...
class Resources extends Component {
    ...
    render() {
        ...
        return (
            <HashRouter>
                <div>
                    <Menu size='massive' className="NavBar" pointing secondary>
                        <Menu.Item name='topic1' active={activeItem === 'topic1'} onClick={this.handleItemClick}>
                            <NavLink to="/resources/topic1">topic1</NavLink>
                        </Menu.Item>
                        <Menu.Item name='topic2' active={activeItem === 'topic2'} onClick={this.handleItemClick}>
                            <NavLink to="/resources/topic2">topic2</NavLink>
                        </Menu.Item>
                    </Menu>
                    <div className="content">
                        <Route path="/resources/topic1" component={AccordionExampleFluid}/>
                        <Route path="/resources/topic2" component={AccordionExampleFluid}/>
                    </div>
                </div>
            </HashRouter>
        );
